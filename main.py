...
os.environ['WANDB_API_KEY'] = '83a5b034f20c9f0e067de7b481c2d0e41'
...
def main():
    ...
    wandb.init(project="RandAugment",name='{}_{}_{}'.format(args.arch, args.dataset, "20220328"))
    
    torch.cuda.set_device(args.local_rank)
    torch.distributed.init_process_group(backend='nccl', init_method='env://')

    num_class, _, _, prefix = dataset_config.return_dataset(args.dataset, args.modality)
    ...
    train_dataset = TSNDataSet(args.dataset_root_path,
                   args.train_list,
    ...
    val_dataset = TSNDataSet(args.dataset_root_path,
                   args.val_list,
                   num_segments=args.num_segments,
                   new_length=data_length,
                   modality=args.modality,
