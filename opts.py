# -*- coding: utf-8 -*-
# phoenixyli 李岩 @2020-04-02 18:09:31

import argparse
parser = argparse.ArgumentParser(description="PyTorch implementation of Temporal Excitation and Aggregation Module")
parser.add_argument('dataset', type=str)
parser.add_argument('modality', type=str, choices=['RGB', 'Flow'])
parser.add_argument('--dataset_root_path', type=str, default="/workspace/datasets/20bn-something-something-v1")
parser.add_argument('--train_list', type=str, default="./caption/S-S V1/train_videofolder.txt")
parser.add_argument('--val_list', type=str, default="./caption/S-S V1/val_videofolder.txt")
...
parser.add_argument('--experiment_name',type=str, default='TEA')
